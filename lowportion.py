...
#  May the next imports be deleted?
...
def lowportion(arrayfield, splitch, feature, parent):
    ...
    Since the last channel is used in RSI spectre to store the cosmic count,
    this channel is removed from the spectra before calculation.
...
def extractpeak(arrayfield, fromch, toch, borderch, feature, parent):
    ...
    Borderch is the number of channels on each side of the peak used to
    calculate the background, typically 5.
